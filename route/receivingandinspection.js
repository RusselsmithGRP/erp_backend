...
router.put('/updateworkcompletion/:id', jwt, receivingAndInspectionController.updateWorkCompletion);
router.get('/getissuedworkcompletion/:id', jwt, receivingAndInspectionController.getIssuedWorkCompletion);
router.post('/submitrejectionlog', jwt, receivingAndInspectionController.submitRejectionLog);
router.get('/allrejectionlogs/', jwt, receivingAndInspectionController.allRejectionLogs);
router.get('/getrejectionlog/:id', jwt, receivingAndInspectionController.getRejectionLog);
